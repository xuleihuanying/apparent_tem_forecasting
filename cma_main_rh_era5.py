    ...
    for index_point in range(0, 1):
        for index_lead in range(0, 12):
            ...
            checkpointer = ModelCheckpoint(
                'E://xulei//era5_predict//rh//' + 'point_' + str(index_point + 1) + '//lead_' + str(
            ...
            # seq.load_weights('E://xulei//era5_predict//rh//' + 'point_' + str(index_point + 1) + '//lead_' + str(
            #     index_lead + 1) + '//' + 'weights')
            #fit model
            history = seq.fit_generator(generate_arrays_from_file('E://xulei//era5_predict//rh//' + 'point_' + str(index_point + 1) +  '//lead_' + str(
                index_lead + 1) + '//'),steps_per_epoch = count_train_steps, validation_data=generate_arrays_from_file_val('E://xulei//era5_predict//rh//' +
            ...
            error[0:len(t), 1] = t
            hdf5storage.savemat('E://xulei//era5_predict//rh//' + 'point_' + str(index_point + 1) +  '//lead_' + str(
            ...
            for i in range(count_test_steps):
                ...
                # hdf5storage.savemat('E://xulei//era5_predict//rh//' + 'point_' + str(index_point + 1) + '//lead_' + str(
                #     index_lead + 1) + '//' + 'test_data_predict_std_' + str(i + 1) + '.mat', {'y_pre_std': y_pre_std})
