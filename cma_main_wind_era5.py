    ...
    for index_point in range(0, 1):
        for index_lead in range(0, 12):
            ...
            checkpointer = ModelCheckpoint(
                'D://xulei//era5_predict//wind//' + 'point_' + str(index_point + 1) + '//lead_' + str(
            ...
            # seq.load_weights('D://xulei//era5_predict//wind//' + 'point_' + str(index_point + 1) + '//lead_' + str(
            #     index_lead + 1) + '//' + 'weights')
            #fit model
            history = seq.fit_generator(generate_arrays_from_file('D://xulei//era5_predict//wind//' + 'point_' + str(index_point + 1) +  '//lead_' + str(
                index_lead + 1) + '//'),steps_per_epoch = count_train_steps, validation_data=generate_arrays_from_file_val('D://xulei//era5_predict//wind//' +
            ...
            error[0:len(t), 1] = t
            hdf5storage.savemat('D://xulei//era5_predict//wind//' + 'point_' + str(index_point + 1) +  '//lead_' + str(
